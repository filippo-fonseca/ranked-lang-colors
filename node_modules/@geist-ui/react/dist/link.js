...
/* harmony import */ var _utils_color__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(52);
...
var Link = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.forwardRef(function (_ref, ref) {
  var href = _ref.href,
      color = _ref.color,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", _extends({
    ...
    ref: ref,
    className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default.a.dynamic([["2189209741", [linkColor, padding, padding, block ? theme.layout.radius : 0, decoration, block ? Object(_utils_color__WEBPACK_IMPORTED_MODULE_6__["addColorAlpha"])(theme.palette.link, 0.1) : 'unset', hoverColor]]]) + " " + (props && props.className != null && props.className || "link ".concat(className))
    ...
    id: "2189209741",
    dynamic: [linkColor, padding, padding, block ? theme.layout.radius : 0, decoration, block ? Object(_utils_color__WEBPACK_IMPORTED_MODULE_6__["addColorAlpha"])(theme.palette.link, 0.1) : 'unset', hoverColor]
  }, ".link.__jsx-style-dynamic-selector{display:-webkit-inline-box;display:-webkit-inline-flex;display:-ms-inline-flexbox;display:inline-flex;-webkit-align-items:baseline;-webkit-box-align:baseline;-ms-flex-align:baseline;align-items:baseline;line-height:inherit;color:".concat(linkColor, ";-webkit-text-decoration:none;text-decoration:none;padding:calc(").concat(padding, " * 0.8) calc(").concat(padding, " * 1.7);border-radius:").concat(block ? theme.layout.radius : 0, ";width:-webkit-fit-content;width:-moz-fit-content;width:fit-content;-webkit-transition:color 200ms ease 0ms;transition:color 200ms ease 0ms;}.link.__jsx-style-dynamic-selector:hover,.link.__jsx-style-dynamic-selector:active,.link.__jsx-style-dynamic-selector:focus{-webkit-text-decoration:").concat(decoration, ";text-decoration:").concat(decoration, ";}.link.__jsx-style-dynamic-selector:hover{background-color:").concat(block ? Object(_utils_color__WEBPACK_IMPORTED_MODULE_6__["addColorAlpha"])(theme.palette.link, 0.1) : 'unset', ";color:").concat(hoverColor, ";}")));
});
var MemoLink = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.memo(Link);
...
/* harmony default export */ __webpack_exports__["default"] = (/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.memo(LinkIcon));
